...
public class AdminServiceImpl implements AdminService{
	...
	public AdminDto authenticateAdmin(String username, String password) {
		Optional<Admin> adminOptional = adminRepository.findByAdmUsername(username);
		if (adminOptional.isPresent()) {
			Admin admin = adminOptional.get();
			if (admin.getAdmPassword().equals(password)) {
				return AdminMapper.mapToAdminDto(admin);
			}
		}
		return null;
...
//    @Override
//	Adm authenticateAdmin(String username, String password) {
